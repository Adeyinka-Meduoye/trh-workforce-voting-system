...
const App: React.FC = () => {
  ...
  const handleViewChange = (newView: View) => {
    const hash = newView === View.HOME ? '' : `#${newView.toLowerCase()}`;
        ...
        {view === View.HOME && (
          <>
            <section className="relative w-full max-w-6xl mx-auto px-4 sm:px-6 mb-16 sm:mb-24">
              ...
              {/* Hero Background Image Container */}
              <div className="absolute inset-0 z-0 rounded-[3rem] overflow-hidden opacity-40 mask-gradient">
                <img
                  src="/images/trh.jpg"
                  alt="Workforce Background"
                  className="w-full h-full object-cover scale-110"
                />
                {/* Adjusted gradient to ensure the image is visible in the center */}
                <div className="absolute inset-0 bg-gradient-to-b from-[#020617] via-[#020617]/20 to-[#020617]"></div>
              </div>
              ...
              <div className="text-center py-12 sm:py-24">
                ...
                <div className="animate-hero-reveal [animation-delay:600ms] flex flex-wrap justify-center gap-4 mb-16">
                  <button
                    onClick={() => handleViewChange(View.WINNERS)}
                    className="px-8 py-3 bg-[#fb8c00] text-[#1e145e] rounded-2xl text-sm font-bold shadow-lg shadow-orange-500/20 hover:bg-white transition-all hover:scale-105"
                  >
                    View Winners
                  </button>
                  <button
                    onClick={() => handleViewChange(View.ABOUT)}
                    className="px-8 py-3 glass rounded-2xl text-sm font-bold border-white/20 hover:border-[#f04124]/40 transition-all hover:scale-105"
                  >
                    About
                  </button>
                </div>
                ...
                <button
                  ...
                  className="animate-hero-reveal [animation-delay:800ms] group flex flex-col items-center gap-4 mx-auto"
                >
