      ...
      <div className="space-y-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <ScrollReveal delay={100}>
            <div className="glass h-full p-10 rounded-[2rem] border-l-8 border-[#fb8c00] hover:scale-[1.02] transition-transform">
          ...
          <ScrollReveal delay={200}>
            <div className="glass h-full p-10 rounded-[2rem] border-l-8 border-[#f04124] flex flex-col justify-center hover:scale-[1.02] transition-transform">
